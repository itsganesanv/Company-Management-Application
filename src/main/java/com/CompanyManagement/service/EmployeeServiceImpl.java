...
public class EmployeeServiceImpl implements EmployeeService{
    ...
    public Employee save(EmployeeRegistrationDto registrationDto) {
        ...
        Employee employee = new Employee(registrationDto.getFirstName(), registrationDto.getLastName(), registrationDto.getOib(), registrationDto.getAddress(), registrationDto.getEmail(), passwordEncoder.encode(registrationDto.getPasswd()), List.of(userRole));
